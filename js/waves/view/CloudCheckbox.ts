...
class CloudCheckbox extends GreenhouseEffectCheckbox {
  public constructor( cloudEnabledProperty: Property<boolean>,
    ...
    const options = optionize<CloudCheckboxOptions, SelfOptions, GreenhouseEffectCheckboxOptions>()( {
      ...
      helpText: MyGreenhouseEffectStrings.a11y.cloudCheckboxHelpTextStringProperty
    }, providedOptions );

    super( cloudEnabledProperty, MyGreenhouseEffectStrings.cloudStringProperty, options );
  }
}

myGreenhouseEffect.register( 'CloudCheckbox', CloudCheckbox );
