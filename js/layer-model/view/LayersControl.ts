...
class LayersControl extends Panel {
  ...
  public constructor( width: number, layersModel: LayerModelModel, tandem: Tandem ) {
    ...
    const options = {
      ...
      tagName: 'div',
      labelTagName: 'h3',
      labelContent: MyGreenhouseEffectStrings.infraredStringProperty,
    ...
    const titleText = new Text( MyGreenhouseEffectStrings.infraredStringProperty, {
    ...
    const numberOfLayersNumberPicker = new NumberPicker(
      ...
      new Property( new Range( 0, MAX_LAYERS ) ),
      {
        ...
        arrowHeight: 8,
        backgroundColor: MyGreenhouseEffectColors.controlPanelBackgroundColorProperty,
    ...
    const layerNumberControlLabel = new Text( MyGreenhouseEffectStrings.absorbingLayersStringProperty, {
      font: HEADING_FONT
    } );
    ...
    const irAbsorbanceSliderLabel = new Text( MyGreenhouseEffectStrings.infraredAbsorbanceStringProperty, {
      font: HEADING_FONT
    } );
    ...
    const irAbsorbanceSlider = new HSlider(
      ...
      absorbanceRange,
      {
        ...
        thumbSize: MyGreenhouseEffectConstants.HORIZONTAL_SLIDER_THUMB_SIZE,
        thumbTouchAreaXDilation: 8,
        thumbTouchAreaYDilation: 8,
        majorTickLength: MyGreenhouseEffectConstants.HORIZONTAL_SLIDER_THUMB_SIZE.height * 0.6,
        minorTickLength: MyGreenhouseEffectConstants.HORIZONTAL_SLIDER_THUMB_SIZE.height * 0.25,
        tickLabelSpacing: 2,
    ...
    irAbsorbanceSlider.addMajorTick(
      absorbanceRange.min,
      new Text(
        new PatternStringProperty( MyGreenhouseEffectStrings.valuePercentPatternStringProperty, {
...
myGreenhouseEffect.register( 'LayersControl', LayersControl );
