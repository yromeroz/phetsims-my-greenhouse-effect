...
class TemperatureUnitsSelector extends VBox {
  public constructor( temperatureUnitsProperty: Property<TemperatureUnits>, tandem: Tandem ) {
    ...
    const label = new Text( MyGreenhouseEffectStrings.temperatureUnitsStringProperty, {
      font: LABEL_FONT,
      maxWidth: 200,
    ...
    const temperatureUnitsRadioButtonGroup = new AquaRadioButtonGroup(
      ...
      [
        {
          createNode: tandem => new Text( MyGreenhouseEffectStrings.temperature.units.kelvinStringProperty, {
            font: LABEL_FONT,
        ...
        {
          createNode: tandem => new Text( MyGreenhouseEffectStrings.temperature.units.celsiusStringProperty, {
            font: LABEL_FONT,
            maxWidth: UNITS_LABEL_MAX_WIDTH,
            tandem: tandem.createTandem( 'text' )
          } ),
        ...
        {
          createNode: tandem => new Text( MyGreenhouseEffectStrings.temperature.units.fahrenheitStringProperty, {
            font: LABEL_FONT,
            maxWidth: UNITS_LABEL_MAX_WIDTH,
            tandem: tandem.createTandem( 'text' )
          } ),
...
myGreenhouseEffect.register( 'TemperatureUnitsSelector', TemperatureUnitsSelector );
