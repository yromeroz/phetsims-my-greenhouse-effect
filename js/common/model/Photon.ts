...
// constants
const PHOTON_SPEED = MyGreenhouseEffectConstants.SPEED_OF_LIGHT;
...
const IR_WAVELENGTH = MyGreenhouseEffectConstants.INFRARED_WAVELENGTH;
const VISIBLE_WAVELENGTH = MyGreenhouseEffectConstants.VISIBLE_WAVELENGTH;
...
class Photon {
  ...
  public get isVisible(): boolean {
    return this.wavelength === MyGreenhouseEffectConstants.VISIBLE_WAVELENGTH;
  }
  ...
  public get isInfrared(): boolean {
    return this.wavelength === MyGreenhouseEffectConstants.INFRARED_WAVELENGTH;
  }
...
myGreenhouseEffect.register( 'Photon', Photon );
export { ShowState };
