...
class PhotonAbsorbingEmittingLayer {
  ...
  private static createPhotonReleaseVelocity(): Vector2 {
    const velocity = new Vector2( 0, MyGreenhouseEffectConstants.SPEED_OF_LIGHT );
...
myGreenhouseEffect.register( 'PhotonAbsorbingEmittingLayer', PhotonAbsorbingEmittingLayer );
