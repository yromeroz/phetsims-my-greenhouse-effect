...
class GreenhouseEffectIconFactory {
  ...
  private static createPhotonImageSet( proportionateYPositions: number[], wavelength: number ): Node[] {
    ...
    const imageSource = wavelength === MyGreenhouseEffectConstants.INFRARED_WAVELENGTH ?
                        infraredPhoton_png :
                        visiblePhoton_png;
...
myGreenhouseEffect.register( 'GreenhouseEffectIconFactory', GreenhouseEffectIconFactory );
