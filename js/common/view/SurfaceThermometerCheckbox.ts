  ...
  public constructor( property: Property<boolean>,
    ...
    Multilink.multilink( [ temperatureProperty, temperatureUnitsProperty ], ( temperature, units ) => {
      checkedUtterance.alert = StringUtils.fillIn(
        MyGreenhouseEffectStrings.a11y.thermometerShownAlertPatternStringProperty,
        {
    ...
    super( property, MyGreenhouseEffectStrings.surfaceThermometerStringProperty, {
      iconNode: iconNode,

      // pdom
      helpText: MyGreenhouseEffectStrings.a11y.surfaceThermometer.helpTextStringProperty,
      checkedContextResponse: checkedUtterance,
      uncheckedContextResponse: MyGreenhouseEffectStrings.a11y.thermometerRemovedAlertStringProperty,
...
myGreenhouseEffect.register( 'SurfaceThermometerCheckbox', SurfaceThermometerCheckbox );
