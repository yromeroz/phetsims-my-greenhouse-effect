...
// constants
const greenhouseGasesInAtmospherePatternStringProperty = MyGreenhouseEffectStrings.a11y.waves.screenSummary.greenhouseGasesInAtmospherePatternStringProperty;
const greenhouseGasesValuePatternStringProperty = MyGreenhouseEffectStrings.a11y.waves.screenSummary.greenhouseGasesValuePatternStringProperty;

// strings used to describe the levels of concentration in the model
const noStringProperty = MyGreenhouseEffectStrings.a11y.qualitativeAmountDescriptions.noStringProperty;
...
const maxStringProperty = MyGreenhouseEffectStrings.a11y.qualitativeAmountDescriptions.maxStringProperty;
const historicalLevelsOfGreenhouseGassesPatternStringProperty = MyGreenhouseEffectStrings.a11y.historicalLevelsOfGreenhouseGassesPatternStringProperty;
...
const iceAgeStringProperty = MyGreenhouseEffectStrings.a11y.timePeriodDescriptions.iceAgeStringProperty;
const seventeenFiftyStringProperty = MyGreenhouseEffectStrings.a11y.timePeriodDescriptions.seventeenFiftyStringProperty;
const nineteenFiftyStringProperty = MyGreenhouseEffectStrings.a11y.timePeriodDescriptions.nineteenFiftyStringProperty;
const twentyTwentyStringProperty = MyGreenhouseEffectStrings.a11y.timePeriodDescriptions.twentyTwentyStringProperty;

const thereIsALargeGlacierStringProperty = MyGreenhouseEffectStrings.a11y.thereIsALargeGlacierStringProperty;
const thereIsAFarmStringProperty = MyGreenhouseEffectStrings.a11y.thereIsAFarmStringProperty;
const thereAreAFewHomesAndFactoriesStringProperty = MyGreenhouseEffectStrings.a11y.thereAreAFewHomesAndFactoriesStringProperty;
const thereAreManyHomesAndFactoriesStringProperty = MyGreenhouseEffectStrings.a11y.thereAreManyHomesAndFactoriesStringProperty;
const aLargeGlacierStringProperty = MyGreenhouseEffectStrings.a11y.aLargeGlacierStringProperty;
const aFarmStringProperty = MyGreenhouseEffectStrings.a11y.aFarmStringProperty;
const aFewHomesAndFactoriesStringProperty = MyGreenhouseEffectStrings.a11y.aFewHomesAndFactoriesStringProperty;
const manyHomesAndFactoriesStringProperty = MyGreenhouseEffectStrings.a11y.manyHomesAndFactoriesStringProperty;

// strings used to describe the sky
const skyDescriptionPatternStringProperty = MyGreenhouseEffectStrings.a11y.sky.skyDescriptionPatternStringProperty;
const cloudyStringProperty = MyGreenhouseEffectStrings.a11y.sky.cloudyStringProperty;
const clearStringProperty = MyGreenhouseEffectStrings.a11y.sky.clearStringProperty;
...
class ConcentrationDescriber {
  ...
  public static getSkyCloudChangeDescription( cloudEnabled: boolean, isShining: boolean ): string {
    ...
    const addedOrRemovedDescriptionProperty = cloudEnabled ?
                                      MyGreenhouseEffectStrings.a11y.sky.cloudAddedAlertStringProperty :
                                      MyGreenhouseEffectStrings.a11y.sky.cloudRemovedAlertStringProperty;
    if ( isShining ) {
      const receivedOrReflectedDescriptionProperty = cloudEnabled ?
                                             MyGreenhouseEffectStrings.a11y.sky.someSunlightReflectedAlertStringProperty :
                                             MyGreenhouseEffectStrings.a11y.sky.allSunlightReachesSurfaceAlertStringProperty;

      description = StringUtils.fillIn( MyGreenhouseEffectStrings.a11y.sky.cloudAlertPatternStringProperty, {
  ...
  public static getDescribedTimePeriodString( timePeriodValue: ConcentrationDate ): string {
    ...
    return StringUtils.fillIn( MyGreenhouseEffectStrings.a11y.timePeriodDescriptionPatternStringProperty, {
  ...
  public static getObservationWindowNowTimePeriodDescription( timePeriodValue: ConcentrationDate ): string {
    return StringUtils.fillIn( MyGreenhouseEffectStrings.a11y.observationWindowTimePeriodPatternStringProperty, {
  ...
  public static getFullTimePeriodDescription( timePeriodValue: ConcentrationDate, capitalize: boolean ): string {
    ...
    let fullTimePeriodDescription = StringUtils.fillIn(
      MyGreenhouseEffectStrings.a11y.waves.screenSummary.timePeriodPatternStringProperty,
  ...
  public static getTimePeriodChangeDescription( timePeriodValue: ConcentrationDate ): string {
    return StringUtils.fillIn( MyGreenhouseEffectStrings.a11y.timePeriodChangeDescriptionPatternStringProperty, {
  ...
  public static getCurrentConcentrationLevelsDescription( concentrationValue: number ): string {
    return StringUtils.fillIn( MyGreenhouseEffectStrings.a11y.nowLevelsOfConcentrationPatternStringProperty, {
  ...
  public static getQualitativeConcentrationChangeDescription( oldConcentrationValue: number,
    ...
    if ( concentrationValuesDifference > 0 ) {
      if ( concentrationValuesDifference <= 0.04 ) {
        qualitativeDescriptionString = MyGreenhouseEffectStrings.a11y.higherStringProperty.value;
      }
      else if ( concentrationValuesDifference <= 0.1 ) {
        qualitativeDescriptionString = MyGreenhouseEffectStrings.a11y.muchHigherStringProperty.value;
      }
      else {
        qualitativeDescriptionString = MyGreenhouseEffectStrings.a11y.significantlyHigherStringProperty.value;
      }
    }
    else {
      if ( concentrationValuesDifference >= -0.04 ) {
        qualitativeDescriptionString = MyGreenhouseEffectStrings.a11y.lowerStringProperty.value;
      }
      else if ( concentrationValuesDifference >= -0.1 ) {
        qualitativeDescriptionString = MyGreenhouseEffectStrings.a11y.muchLowerStringProperty.value;
      }
      else {
        qualitativeDescriptionString = MyGreenhouseEffectStrings.a11y.significantlyLowerStringProperty.value;
      }
    }

    return StringUtils.fillIn(
      MyGreenhouseEffectStrings.a11y.qualitativeConcentrationChangeDescriptionPatternStringProperty,
      {
  ...
  public static getConcentrationDescription( concentration: number ): string {
    ...
    if ( roundedConcentration === 0 ) {
      ...
      descriptionString = StringUtils.fillIn( MyGreenhouseEffectStrings.a11y.levelsOfPatternStringProperty, {
...
myGreenhouseEffect.register( 'ConcentrationDescriber', ConcentrationDescriber );
