...
const infraredEmissionIntensityPatternStringProperty = MyGreenhouseEffectStrings.a11y.infraredEmissionIntensityPatternStringProperty;
const infraredEmissionIntensityWithRedirectionPatternStringProperty = MyGreenhouseEffectStrings.a11y.infraredEmissionIntensityWithRedirectionPatternStringProperty;
const sunlightStartedStringProperty = MyGreenhouseEffectStrings.a11y.sunlightStartedStringProperty;
const sunlightStartedSimPausedStringProperty = MyGreenhouseEffectStrings.a11y.sunlightStartedSimPausedStringProperty;
...
class RadiationDescriber {
  ...
  public static getRadiationRedirectionDescription( newConcentration: number, oldConcentration: number ): string | null {
    return RadiationDescriber.getRadiationChangeDescription(
      MyGreenhouseEffectStrings.a11y.infraredRadiationRedirectingPatternStringProperty.value,
      newConcentration,
      oldConcentration,
  ...
  public static getRadiationFromSurfaceChangeDescription( newConcentration: number, oldConcentration: number ): string | null {
    return RadiationDescriber.getRadiationChangeDescription(
      MyGreenhouseEffectStrings.a11y.infraredRadiationEmittedFromSurfacePatternStringProperty.value,
      newConcentration,
      oldConcentration
    );
  }
  ...
  private static getRadiationChangeDescription( patternString: string, newConcentration: number, oldConcentration: number, describeNoConcentration?: boolean ): string | null {
    ...
    if ( newConcentration !== oldConcentration ) {
      ...
      if ( describeNoConcentration && newConcentration === 0 ) {
        changeString = MyGreenhouseEffectStrings.a11y.noStringProperty.value;
      }
      else {
        changeString = newConcentration > oldConcentration ?
                       MyGreenhouseEffectStrings.a11y.moreStringProperty.value :
                       MyGreenhouseEffectStrings.a11y.lessStringProperty.value;
      }
  ...
  private static getRedirectedInfraredDescription( concentration: number,
    ...
    return StringUtils.capitalize( StringUtils.fillIn( MyGreenhouseEffectStrings.a11y.amountOfPatternStringProperty, {
  ...
  public static getSunlightTravelDescription( includeCloudReflection: boolean,
    ...
    if ( !includeCloudReflection && !includeGlacierReflection ) {
      descriptionString = MyGreenhouseEffectStrings.a11y.sunlightWavesTravelFromSpaceStringProperty.value;
    }
    else if ( includeCloudReflection && !includeGlacierReflection ) {
      descriptionString = StringUtils.fillIn( MyGreenhouseEffectStrings.a11y.sunlightAndReflectionPatternStringProperty, {
        sunlightDescription: MyGreenhouseEffectStrings.a11y.sunlightWavesTravelFromSpaceStringProperty,
        reflectionDescription: MyGreenhouseEffectStrings.a11y.cloudRefectionStringProperty
      } );
    }
    else if ( !includeCloudReflection && includeGlacierReflection ) {
      ...
      descriptionString = StringUtils.fillIn( MyGreenhouseEffectStrings.a11y.sunlightAndReflectionPatternStringProperty, {
        sunlightDescription: MyGreenhouseEffectStrings.a11y.sunlightWavesTravelFromSpaceStringProperty,
        reflectionDescription: MyGreenhouseEffectStrings.a11y.cloudAndGlacierRefectionStringProperty
      } );
    }
...
myGreenhouseEffect.register( 'RadiationDescriber', RadiationDescriber );
