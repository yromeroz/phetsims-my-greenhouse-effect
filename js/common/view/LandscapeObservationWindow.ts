...
import customBackground_png from '../../../images/customBackground_png.js';
import backgroundSun_png from '../../../images/backgroundSun_png.js';
import tomatoPlantWithFlowers_png from '../../../images/tomatoPlantWithFlowers_png.js';
...
class LandscapeObservationWindow extends GreenhouseEffectObservationWindow {
  ...
  public constructor( model: ConcentrationModel, providedOptions?: LandscapeObservationWindowOptions ) {
    ...
    if ( MyGreenhouseEffectQueryParameters.showAllLayers ) {
      ...
      energyAbsorbingEmittingLayerNodes.push( new LayerDebugNode(
        ...
        this.modelViewTransform,
        {
          ...
          visible: MyGreenhouseEffectQueryParameters.showAllLayers
        }
      ) );
  ...
  protected override createGroundNode( model: ConcentrationModel ): Node {
    ...
    const backgroundSunImageOptions = {
      maxWidth: this.width / 6,
      centerX: SIZE.width - 100,
      centerY: SIZE.height / 2 - 190
    };

    const tomatoPlantWithFlowersImageOptions = {
      maxWidth: this.width / 4,
      centerX: this.width / 2 + 20,
      centerY: SIZE.height / 2 + 60
    };
    ...
    const customBackgroundImage = new Image( customBackground_png, sharedImageOptions );
    const backgroundSunImage = new Image( backgroundSun_png, backgroundSunImageOptions );
    const tomatoPlantWithFlowersImage = new Image( tomatoPlantWithFlowers_png, tomatoPlantWithFlowersImageOptions );
...
myGreenhouseEffect.register( 'LandscapeObservationWindow', LandscapeObservationWindow );
