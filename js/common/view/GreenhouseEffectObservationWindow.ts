...
class GreenhouseEffectObservationWindow extends Node {
  ...
  public constructor( model: LayersModel, providedOptions?: GreenhouseEffectObservationWindowOptions ) {
    ...
    const options = optionize<GreenhouseEffectObservationWindowOptions, StrictOmit<SelfOptions, 'fluxMeterNodeOptions'>, NodeOptions>()( {
      ...
      left: MyGreenhouseEffectConstants.SCREEN_VIEW_X_MARGIN,
      top: MyGreenhouseEffectConstants.SCREEN_VIEW_Y_MARGIN,
    ...
    this.focusableHeadingNode = new FocusableHeadingNode( {
      headingLevel: 3,
      innerContent: MyGreenhouseEffectStrings.a11y.observationWindowLabelStringProperty
    } );
    ...
    this.startSunlightButton = new TextPushButton( MyGreenhouseEffectStrings.startSunlightStringProperty, {
      ...
      // pdom
      helpText: MyGreenhouseEffectStrings.a11y.startSunlightButtonHelpTextStringProperty,
...
myGreenhouseEffect.register( 'GreenhouseEffectObservationWindow', GreenhouseEffectObservationWindow );
