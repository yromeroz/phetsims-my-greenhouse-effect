      ...
      if ( !isPlaying ) {
        if ( !model.sunEnergySource.isShiningProperty.value ) {
          ...
          this.alertDescriptionUtterance(
            MyGreenhouseEffectStrings.a11y.timeControls.simPausedSunlightOffAlertStringProperty
          );
        }
        else {
          ...
          this.alertDescriptionUtterance(
            MyGreenhouseEffectStrings.a11y.timeControls.simPausedEmitterOnAlertStringProperty
          );
        }
      }
      else {
        if ( !model.sunEnergySource.isShiningProperty.value ) {
          ...
          this.alertDescriptionUtterance(
            MyGreenhouseEffectStrings.a11y.timeControls.simPlayingSunlightOffAlertStringProperty
          );
        }
      }
    } );
...
myGreenhouseEffect.register( 'LayersModelTimeControlNode', LayersModelTimeControlNode );
