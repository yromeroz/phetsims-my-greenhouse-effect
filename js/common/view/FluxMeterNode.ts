...
const sunlightStringProperty = MyGreenhouseEffectStrings.sunlightStringProperty;
const infraredStringProperty = MyGreenhouseEffectStrings.infraredStringProperty;
const energyFluxStringProperty = MyGreenhouseEffectStrings.fluxMeter.energyFluxStringProperty;
...
class FluxMeterNode extends Node {
  ...
  public constructor( model: FluxMeter,
    ...
    this.sunlightFluxDisplay = new EnergyFluxDisplay(
      ...
      MyGreenhouseEffectColors.sunlightColorProperty
    );
    this.infraredFluxDisplay = new EnergyFluxDisplay(
      ...
      MyGreenhouseEffectColors.infraredColorProperty
    );
...
myGreenhouseEffect.register( 'FluxMeterNode', FluxMeterNode );
