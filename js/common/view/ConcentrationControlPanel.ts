...
// constants
const lotsStringProperty = MyGreenhouseEffectStrings.concentrationPanel.lotsStringProperty;
const noneStringProperty = MyGreenhouseEffectStrings.concentrationPanel.noneStringProperty;
const carbonDioxideConcentrationPatternStringProperty = MyGreenhouseEffectStrings.concentrationPanel.carbonDioxideConcentrationPatternStringProperty;
const methaneConcentrationPatternStringProperty = MyGreenhouseEffectStrings.concentrationPanel.methaneConcentrationPatternStringProperty;
const nitrousOxideConcentrationPatternStringProperty = MyGreenhouseEffectStrings.concentrationPanel.nitrousOxideConcentrationPatternStringProperty;
...
const LABEL_OPTIONS = { font: MyGreenhouseEffectConstants.CONTENT_FONT, maxWidth: 60 };
...
const RADIO_BUTTON_GROUP_OPTIONS = {
  radioButtonOptions: {
    baseColor: MyGreenhouseEffectColors.controlPanelBackgroundColorProperty,
    buttonAppearanceStrategyOptions: {
      selectedStroke: MyGreenhouseEffectColors.radioButtonGroupSelectedStrokeColorProperty,
      selectedLineWidth: 2
    }
  }
};
...
class ConcentrationControlPanel extends Panel {
  ...
  public constructor( width: number,
    ...
    const options = optionize<ConcentrationControlPanelOptions, SelfOptions, PanelOptions>()( {
      ...
      fill: MyGreenhouseEffectColors.controlPanelBackgroundColorProperty,

      // pdom
      tagName: 'div',
      labelTagName: 'h3',
      labelContent: MyGreenhouseEffectStrings.a11y.concentrationPanel.titleStringProperty,
    ...
    const titleText = new Text( MyGreenhouseEffectStrings.concentrationPanel.greenhouseGasConcentrationStringProperty, {
...
class DateControl extends HBox {
  ...
  public constructor( dateProperty: EnumerationProperty<ConcentrationDate>,
    ...
    const iceAgeLabel = MyGreenhouseEffectStrings.concentrationPanel.iceAgeStringProperty.value;
    ...
    const items = [
      {
        ...
        labelContent: MyGreenhouseEffectStrings.a11y.concentrationPanel.timePeriod.yearTwentyTwentyStringProperty,
      ...
      },
      {
        ...
        labelContent: MyGreenhouseEffectStrings.a11y.concentrationPanel.timePeriod.yearNineteenFiftyStringProperty,
      ...
      },
      {
        ...
        labelContent: MyGreenhouseEffectStrings.a11y.concentrationPanel.timePeriod.yearSeventeenFiftyStringProperty,
        tandemName: 'seventeenFiftyRadioButton'
      },
      {
        createNode: () => new Text( iceAgeLabel, LABEL_OPTIONS ),
        value: ConcentrationDate.ICE_AGE,
        labelContent: MyGreenhouseEffectStrings.a11y.concentrationPanel.timePeriod.iceAgeStringProperty,
    ...
    const dateRadioButtonGroup = new RectangularRadioButtonGroup(
      ...
      combineOptions<RectangularRadioButtonGroupOptions>( {
        ...
        // pdom
        labelTagName: 'h4',
        labelContent: MyGreenhouseEffectStrings.a11y.concentrationPanel.timePeriod.labelStringProperty,
        helpText: MyGreenhouseEffectStrings.a11y.concentrationPanel.timePeriod.helpTextStringProperty,
...
class ConcentrationSlider extends VBox {
  public constructor( concentrationModel: ConcentrationModel, radiationDescriber: RadiationDescriber, tandem: Tandem ) {
    ...
    const slider = new VSlider( concentrationModel.manuallyControlledConcentrationProperty, sliderRange, {
      ...
      thumbSize: MyGreenhouseEffectConstants.VERTICAL_SLIDER_THUMB_SIZE,
      ...
      // pdom
      labelContent: MyGreenhouseEffectStrings.a11y.concentrationPanel.concentration.greenhouseGasConcentrationStringProperty,
      labelTagName: 'label',
      helpText: MyGreenhouseEffectStrings.a11y.concentrationPanel.concentration.concentrationSliderHelpTextStringProperty,
      keyboardStep: 0.05,
    ...
    const sliderToLabelSpacing = SLIDER_TRACK_TO_LABEL_SPACING -
                                 MyGreenhouseEffectConstants.VERTICAL_SLIDER_THUMB_SIZE.height / 2 -
  ...
  public constructor( property: EnumerationProperty<ConcentrationControlMode>, tandem: Tandem ) {
    ...
    const items = [
      {
        ...
        labelContent: MyGreenhouseEffectStrings.a11y.concentrationPanel.byConcentrationStringProperty,
        tandemName: 'byConcentrationRadioButton'
      },
      {
        createNode: () => dateIcon,
        value: ConcentrationControlMode.BY_DATE,
        labelContent: MyGreenhouseEffectStrings.a11y.concentrationPanel.byTimePeriodStringProperty,
    ...
    super(
      ...
      combineOptions<RectangularRadioButtonGroupOptions>( {
        ...
        // pdom
        labelTagName: 'h4',
        labelContent: MyGreenhouseEffectStrings.a11y.concentrationPanel.experimentModeStringProperty,
        helpText: MyGreenhouseEffectStrings.a11y.concentrationPanel.experimentModeHelpTextStringProperty,
...
myGreenhouseEffect.register( 'ConcentrationControlPanel', ConcentrationControlPanel );
